...
// Search by brand
$('.popular-menu button').click(function() {
...
$('.btn-hot-next').click(function() {
    ...
    var width = $('.hot .content-wrapper').width() * $('.hot .content-wrapper').length - $('.hot .content-wrapper').width() * amount;
    console.log($('.hot .content-wrapper').width())
    if(position <= width) {
        position += $('.hot .content-wrapper').width() + 32;
        console.log(position)
        $('.hot .content-wrapper').css('transform', 'translateX(-' + position + 'px)');
    }
})
